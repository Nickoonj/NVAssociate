...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\SubscriptionsController' => 'getSubscriptionsControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'pagerfanta.event_listener.convert_not_valid_max_per_page_to_not_found', class: 'BabDev\\PagerfantaBundle\\EventListener\\ConvertNotValidCurrentPageToNotFoundListener')] function () {
            return ($this->privates['pagerfanta.event_listener.convert_not_valid_max_per_page_to_not_found'] ??= new \BabDev\PagerfantaBundle\EventListener\ConvertNotValidCurrentPageToNotFoundListener());
        }, 1 => 'onKernelException'], 512);
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'pagerfanta.event_listener.convert_not_valid_current_page_to_not_found', class: 'BabDev\\PagerfantaBundle\\EventListener\\ConvertNotValidMaxPerPageToNotFoundListener')] function () {
            return ($this->privates['pagerfanta.event_listener.convert_not_valid_current_page_to_not_found'] ??= new \BabDev\PagerfantaBundle\EventListener\ConvertNotValidMaxPerPageToNotFoundListener());
        }, 1 => 'onKernelException'], 512);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g5qyydq9Fl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'babdev_pagerfanta.default_twig_template' => '@BabDevPagerfanta/twitter_bootstrap5.html.twig',
            'babdev_pagerfanta.default_view' => 'SemanticUi',
            'console.command.ids' => [
